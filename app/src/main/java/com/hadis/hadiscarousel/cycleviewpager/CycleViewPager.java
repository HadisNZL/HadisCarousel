...
/**
 * 自定义的viewpager 这里可以是 点指示 ，也可以是数字指示
 *
 * @author hadis
 */
@SuppressLint("NewApi")
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    private TextView tv;// 标题编号
    private TextView memo;// 标题
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv = (TextView) view.findViewById(R.id.ttt);
    ...
    public void onPageSelected(int arg0) {
        ...
        // 设置相应标题
        memo.setText(infos.get(position).getImemo());
        // 设置相应标号
        tv.setText((position + 1) + "/" + (imageViews.size() - 2));
    }
